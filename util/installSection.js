    ...
    heading(tree, /^usage/i, (start, nodes, end) => {
      ...
      if (sugar === 'default') {
        section.push(
          ...
          u('paragraph', [
            u(
              'text',
              `If you would like to use the default configuration, then you don't need to add anything to your `
            ),
        ...
        section.push(
          ...
          u('paragraph', [
            u(
              'text',
              `If you would like to use the preset in its default configuration, specify a section in your `
            ),
            u('inlineCode', 'package.json'),
            u('text', `:`),
          ]),
      ...
      return [
        ...
        u('paragraph', [
          u(
            'text',
            `Depending on your usage, the JSON configuration might not work for you, such as in cases where you would like to use options with customisable function parameters. For this use case, we recommend a `
          ),
        ...
        u(
          'code',
          { lang: 'js' },
          `const ${presetIdentifier} = require('${name}');\n\nmodule.exports = ${presetIdentifier}({\n  discardComments: {\n    remove: comment => comment[0] === "@"\n  }\n});`
        ),
        u('paragraph', [
          u(
            'text',
