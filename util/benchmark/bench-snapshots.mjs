...
export async function runOnce(
  ...
  const provenance = createProvenance({
    ...
    benchmarkConfiguration: {
      ...
      minimumBlocks: args.minimumBlocks,
      requestedBlocks: args.requestedBlocks,
      precisionTarget: args.precisionTarget,
      orderInteractionThreshold: args.orderInteractionThreshold,
      superiorityConfidenceLevel: args.superiorityConfidenceLevel,
      equivalenceConfidenceLevel: args.equivalenceConfidenceLevel,
      runtimeNonRegressionMargin: args.runtimeNonRegressionMargin,
      practicalEquivalenceMargin: args.practicalEquivalenceMargin,
      pinCore: args.pinCore,
