...
test(
  ...
  passthroughCSS,
  'h1{color:#000}/*test*/h2{color:#fff}/*test*/'
);
...
test(
  ...
  passthroughCSS,
  'h1,h2{font-weight:bold}h2,h1{font-weight:bold}'
);

test(
  'should not be responsible for normalising declarations',
  passthroughCSS,
  'h1{margin:10px 0 10px 0;margin:10px 0}'
);
...
test(
  ...
  passthroughCSS,
  'h1{_color:white;color:white}'
);

test(
  'should preserve browser hacks (2)',
  passthroughCSS,
  '@media \0 all {}@media all {}'
);
