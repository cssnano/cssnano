...
test('should convert translucent hsla to rgba', isEqual, 'hsla(0, 100%, 50%, .5)', 'rgba(255, 0, 0, 0.5)');
...
test('should convert rgba to hsla when shorter', isEqual, 'rgba(199, 190, 179, 0.8)', 'hsla(33, 15%, 74%, 0.8)');
...
test('should convert signed numbers', isEqual, 'rgba(-100,0,-100,.5)', 'rgba(0, 0, 0, 0.5)');
test('should convert signed numbers (2)', isEqual, 'hsla(-400,50%,10%,.5)', 'rgba(38, 13, 30, 0.5)');
test('should convert percentage based rgb values', isEqual, 'rgb(100%,100%,100%)', '#fff');
test('should convert percentage based rgba values (2)', isEqual, 'rgba(50%,50%,50%,0.5)', 'hsla(0, 0%, 50%, 0.5)');
test('should convert percentage based rgba values (3)', isEqual, 'rgb(100%,100%,100%)', '#fff');
test('should convert percentage based rgba values (4)', isEqual, 'rgba(100%,100%,100%,0.5)', 'hsla(0, 0%, 100%, 0.5)');
test('should convert percentage based rgba values (5)', isEqual, 'rgba(100%,64.7%,0%,.5)', 'rgba(255, 165, 0, 0.5)');
