...
test(
    'should convert shorthand hex to keyword',
    isEqual,
    '#f00',
    'red'
);
...
test(
    'should convert longhand hex to keyword',
    isEqual,
    '#ff0000',
    'red'
);
...
test(
    'should convert darkgray to a hex',
    isEqual,
    'darkgray',
    '#a9a9a9'
);
