...
test(
  ...
  processCss('h1{animation-duration:-569ms}', 'h1{animation-duration:-569ms}')
);
...
test(
  ...
  processCss('h1{margin:0em 0% 0px 0pc}', 'h1{margin:0}')
);
...
test(
  ...
  processCss('h1{flex-basis:0%}', 'h1{flex-basis:0%}')
);

test(
  'should not mangle values without units',
  processCss('h1{z-index:1}', 'h1{z-index:1}')
);

test(
  'should not mangle values outside of its domain',
  processCss('h1{background:url(a.png)}', 'h1{background:url(a.png)}')
);
...
test(
  ...
  processCss('.long{animation-duration:2s}', '.long{animation-duration:2s}')
);
