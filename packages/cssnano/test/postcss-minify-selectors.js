...
test(
  ...
  processCss('h1 + p, h1 > p, h1 ~ p{color:#00f}', 'h1+p,h1>p,h1~p{color:#00f}')
);

test(
  'should not trim meaningful spaces',
  processCss('h1 p,h2 p{color:#00f}', 'h1 p,h2 p{color:#00f}')
);
...
test(
  ...
  processCss('*:not(*.green) ~ *{color:#00f}', ':not(.green)~*{color:#00f}')
);
