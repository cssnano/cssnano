 ...
 * } ArgumentGrammar
 */
export type ArgumentGrammar = 'forgiving-selector-list' | 'selector-list' | 'relative-selector-list' | 'compound-selector' | 'an-plus-b-of' | 'an-plus-b' | 'ident-or-string-list' | 'ident';
