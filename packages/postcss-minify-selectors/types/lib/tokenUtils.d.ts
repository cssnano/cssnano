...
/** @param {string} value */
export declare function normalizeFormula(value: string): string;
...
export declare function skipUniversal(next: CSSToken | undefined, before: string | undefined): boolean;
