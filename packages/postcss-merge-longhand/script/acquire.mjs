 ...
 * `pnpm fixlint` to reformat the generated file. Commit the result: the
 * generated file is what ships, so a data refresh has to go through the test
 * suite before reaching users.
 */
