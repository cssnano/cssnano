...
describe('computed-state oracle: CSS-wide keywords', () => {
...
describe('computed-state oracle: support-dependent values and fallbacks', () => {
...
describe('retention-heavy cases: duplicate cleanup and fallback preservation', () => {
