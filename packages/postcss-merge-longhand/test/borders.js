...
test(
  'should merge asymmetric border radii in corner order',
  processCSS(
...
test(
  'should merge elliptical border radii',
  processCSS(
    'a{border-top-left-radius:1px 5px;border-top-right-radius:2px 6px;border-bottom-right-radius:1px 5px;border-bottom-left-radius:2px 6px}',
    'a{border-radius:1px 2px/5px 6px}'
  )
);

test(
  'should merge uppercase concrete border radii',
  processCSS(
    'a{BORDER-TOP-LEFT-RADIUS:1PX 5%;BORDER-TOP-RIGHT-RADIUS:2PX 6%;BORDER-BOTTOM-RIGHT-RADIUS:3PX 7%;BORDER-BOTTOM-LEFT-RADIUS:4PX 8%}',
    'a{border-radius:1PX 2PX 3PX 4PX/5% 6% 7% 8%}'
  )
);
