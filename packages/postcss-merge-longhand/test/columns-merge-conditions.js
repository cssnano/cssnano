...
describe('column-height shorthand syntax', () => {
  test(
...
describe('column-height merge blocking', () => {
  test(
...
describe('unrelated border rollback interaction', () => {
  test(
...
describe('ordered shorthand/longhand interleavings', () => {
  test(
...
describe('important and non-important lanes', () => {
  test(
...
describe('fallback-sensitive var(), env(), and calc() cases', () => {
  test(
...
describe('equal-size versus larger replacement decisions', () => {
  test(
