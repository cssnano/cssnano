...
function reduce (node) {
    ...
    if (node.value === 'matrix3d' &&
        node.nodes[30] &&
        parseFloat(node.nodes[4].value) === 0 &&
        parseFloat(node.nodes[6].value) === 0 &&
        parseFloat(node.nodes[12].value) === 0 &&
        parseFloat(node.nodes[14].value) === 0 &&
        parseFloat(node.nodes[16].value) === 0 &&
        parseFloat(node.nodes[18].value) === 0 &&
        parseFloat(node.nodes[20].value) === 1 &&
        parseFloat(node.nodes[22].value) === 0 &&
        parseFloat(node.nodes[28].value) === 0 &&
        parseFloat(node.nodes[30].value) === 1
    ) {
        node.value = 'matrix';
        node.nodes = [
            node.nodes[0],
    ...
    if (node.value === 'rotate3d' &&
        node.nodes[6] &&
        parseFloat(node.nodes[0].value) === 1 &&
    ...
    if (node.value === 'rotate3d' &&
        ...
        parseFloat(node.nodes[2].value) === 1 &&
        parseFloat(node.nodes[4].value) === 0
    ) {
        node.value = 'rotateY';
        node.nodes = [node.nodes[6]];
    ...
    if (node.value === 'rotate3d' &&
        ...
        parseFloat(node.nodes[0].value) === 0 &&
        parseFloat(node.nodes[2].value) === 0 &&
        parseFloat(node.nodes[4].value) === 1
    ) {
        node.value = 'rotate';
        node.nodes = [node.nodes[6]];
        return false;
